#  SpaceGuard: Space Station Object Detection with YOLOv8

SpaceGuard is a complete object detection pipeline using YOLOv8 to identify Toolbox, Oxygen Tank, and Fire Extinguisher in space station environments. It leverages synthetic data from Duality AI Falcon and provides robust, real-time detection and analytics.
